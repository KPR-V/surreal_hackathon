  ...
  return (
    <div className="relative w-full overflow-hidden">
      ...
      <SummaryModal
        ...
        // Pass batch data for cards that support batching
        batchFormData={(cardConfig.id === "register-ip" || cardConfig.id === "register-derivative-ip" || cardConfig.id === "mint-and-register-derivative-ip") ? batchFormData : undefined}
        onRegisterMore={(cardConfig.id === "register-ip" || cardConfig.id === "register-derivative-ip" || cardConfig.id === "mint-and-register-derivative-ip") ? handleRegisterMore : undefined}
